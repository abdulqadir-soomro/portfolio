...
export default function Skills() {
  ...
  const skills = [
    ...
    },
    {
      ...
      technologies: ["Node.js", "Express.js", "NestJS", "REST APIs", "Python"],
      color: "bg-green-500",
    },
    {
      category: "Database",
      icon: <Database className="h-8 w-8" />,
      technologies: ["PostgreSQL", "MongoDB", "Mongoose", "TypeORM"],
      color: "bg-purple-500",
    },
    {
      category: "Cloud / DevOps",
      icon: <Cloud className="h-8 w-8" />,
      technologies: ["AWS (SES, SNS, EC2)", "Firebase", "Supabase", "Docker"],
      color: "bg-orange-500",
    },
    {
      category: "Tools",
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
               ...
               { name: "Python (Web Scraping)", level: 75 },
